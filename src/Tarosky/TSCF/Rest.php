...
class Rest extends Singleton {
	...
	public function rest_api_init() {
		register_rest_route( 'tscf/v1', '/posts', array(
			array(
				'method'              => 'GET',
	...
	public function handle_post( $request ) {
		...
		if ( ! $user_can ) {
			return new \WP_Error( 'no_permission', __( 'No post found.', 'tscf' ), array( 'response' => 403 ) );
		}
		...
		if ( ! $query->have_posts() ) {
			return new \WP_Error( 'no_posts', __( 'No post found.', 'tscf' ), array( 'response' => 404 ) );
		}
